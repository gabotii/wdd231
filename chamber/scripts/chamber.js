...
function displaySpotlights(members) {
    ...
    selectedMembers.forEach((member, index) => {
        const card = createMemberCard(member, 7 + (index * 5)); // Price starts at $11 and increases by $5
        spotlightSection.appendChild(card);
    });
}

function createMemberCard(member, price) {
    ...
    card.innerHTML = `
        ...
        <div class="card-content">
            ...
            <div class="contact-info">
                <p><span>EMAIL:</span> <a href="mailto:info@SublimaLab.org">info@SublimaLab.org</a></p>
